...
class SignupPage(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        uic.loadUi(r"D:\Main project-2\automatic-classroom-attendance-system-master\App\ui\signup.ui", self)
    ...
    def signup(self):
        ...
        if (len(fullname) == 0 or len(username) == 0 or len(email) == 0 or len(password) == 0):
            ...
            try:
                connection = sqlite3.connect(r"D:\Main project-2\automatic-classroom-attendance-system-master\output\database.db")
                try:
                    connection.execute(
