...
from App.widgets.face_detection_widget import FaceDetectionWidget
...
class RegisterStudent(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        uic.loadUi(r"D:\Main project-2\automatic-classroom-attendance-system-master\App\ui\registerStudent.ui", self)
    ...
    def constructOutput(self):
        ...
        self.output = r"D:\Main project-2\automatic-classroom-attendance-system-master\dataset\{}".format(studentName)
